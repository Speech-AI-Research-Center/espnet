...
if ! "${skip_upload_hf}"; then
    if [ ${stage} -le 16 ] && [ ${stop_stage} -ge 16 ]; then
        [ -z "${***REMOVED***repo}" ] && \
            log "ERROR: You need to setup the variable ***REMOVED***repo with the name of the repository located at HuggingFace, follow the following steps if you have not setup the HF account \n: 
	    ...
	    5. set the variable ***REMOVED***repo with the name of this repository" && \ 
            exit 1
