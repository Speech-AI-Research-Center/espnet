...
if ! "${skip_upload_hf}"; then
    if [ ${stage} -le 16 ] && [ ${stop_stage} -ge 16 ]; then
        [ -z "${***REMOVED***repo}" ] && \
            log "ERROR: You need to setup the variable ***REMOVED***repo with the name of the repository located at HuggingFace, follow the following steps described here https://github.com/espnet/espnet/blob/5cc31d748984c7332176ca31a541905c8709300a/CONTRIBUTING.md?plain=1#L68" && \ 
            exit 1
