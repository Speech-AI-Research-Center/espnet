...
if ! "${skip_upload_hf}"; then
    if [ ${stage} -le 16 ] && [ ${stop_stage} -ge 16 ]; then
        [ -z "${***REMOVED***repo}" ] && \
            log "ERROR: You need to setup the variable ***REMOVED***repo with the name of the repository located at HuggingFace, follow the following steps described here https://github.com/espnet/espnet/pull/4027/files#diff-b9f381af6d3ca8c14a68dca2a24de815830013fd69a3fe6a113e108c7aaf0d2dR1490-R1505" && \ 
            exit 1
