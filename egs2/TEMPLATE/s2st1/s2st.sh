...
***REMOVED***repo= # Huggingface repositary for model uploading
...
Options:
    ...
    # Upload model related
    --***REMOVED***repo          # Huggingface repositary for model uploading (default="${***REMOVED***repo}")
...
if ! "${skip_upload_hf}"; then
    if [ ${stage} -le 11 ] && [ ${stop_stage} -ge 11 ]; then
        [ -z "${***REMOVED***repo}" ] && \
            ...
            exit 1
        log "Stage 11: Upload model to HuggingFace: ${***REMOVED***repo}"
